package com.sirisha.toyrobot;

import com.sirisha.toyrobot.exception.ToyRobotException;
import com.sirisha.toyrobot.simulator.*;
...
public class Game {
    ...
    public String eval(String inputString) throws ToyRobotException {
        ...
        try {
            ...
            throw new ToyRobotException("Invalid command, Please Reenter starting with PLACE!");
        }
        if (command == Command.PLACE && args.length < 2) {
            throw new ToyRobotException("Invalid command, Please check the argument count!");
        }
        ...
        if (command == Command.PLACE) {
            ...
            try {
                ...
                throw new ToyRobotException("Invalid command, Please enter the arguments properly!");
            }
        }
